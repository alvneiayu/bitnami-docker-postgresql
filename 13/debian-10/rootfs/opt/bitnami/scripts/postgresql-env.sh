...
postgresql_env_vars=(
    ...
    POSTGRESQL_LOG_ERROR_VERBOSITY
    POSTGRESQL_TIMEZONE
...
POSTGRESQL_LOG_DIRECTORY="${POSTGRESQL_LOG_DIRECTORY:-"${POSTGRES_LOG_DIRECTORY:-}"}"
export POSTGRESQL_LOG_DIRECTORY="${POSTGRESQL_LOG_DIRECTORY:-}"
POSTGRESQL_LOG_TRUNCATE_ON_ROTATION="${POSTGRESQL_LOG_TRUNCATE_ON_ROTATION:-"${POSTGRES_LOG_TRUNCATE_ON_ROTATION:-}"}"
export POSTGRESQL_LOG_TRUNCATE_ON_ROTATION="${POSTGRESQL_LOG_TRUNCATE_ON_ROTATION:-no}"
POSTGRESQL_LOGGING_COLLECTOR="${POSTGRESQL_LOGGING_COLLECTOR:-"${POSTGRES_LOGGING_COLLECTOR:-}"}"
export POSTGRESQL_LOGGING_COLLECTOR="${POSTGRESQL_LOGGING_COLLECTOR:-no}"
POSTGRESQL_LOG_STATEMENT="${POSTGRESQL_LOG_STATEMENT:-"${POSTGRES_LOG_STATEMENT:-}"}"
export POSTGRESQL_LOG_STATEMENT="${POSTGRESQL_LOG_STATEMENT:-}"
POSTGRESQL_LOG_DESTINATION="${POSTGRESQL_LOG_DESTINATION:-"${POSTGRES_LOG_DESTINATION:-}"}"
export POSTGRESQL_LOG_DESTINATION="${POSTGRESQL_LOG_DESTINATION:-}"
POSTGRESQL_SYSLOG_FACILITY="${POSTGRESQL_SYSLOG_FACILITY:-"${POSTGRES_SYSLOG_FACILITY:-}"}"
export POSTGRESQL_SYSLOG_FACILITY="${POSTGRESQL_SYSLOG_FACILITY:-}"
POSTGRESQL_SYSLOG_IDENT="${POSTGRESQL_SYSLOG_IDENT:-"${POSTGRES_SYSLOG_IDENT:-}"}"
export POSTGRESQL_SYSLOG_IDENT="${POSTGRESQL_SYSLOG_IDENT:-}"
POSTGRESQL_LOG_DURATION="${POSTGRESQL_LOG_DURATION:-"${POSTGRES_LOG_DURATION:-}"}"
export POSTGRESQL_LOG_DURATION="${POSTGRESQL_LOG_DURATION:-}"
POSTGRESQL_LOG_ERROR_VERBOSITY="${POSTGRESQL_LOG_ERROR_VERBOSITY:-"${POSTGRES_LOG_ERROR_VERBOSITY:-}"}"
export POSTGRESQL_LOG_ERROR_VERBOSITY="${POSTGRESQL_LOG_ERROR_VERBOSITY:-}"
